...
<!--base de datos-->
<?php
if (isset($_POST['agendar'])) { // Verificar si se envió el formulario
  $Nombre = $_POST["nombre"];
  $Correo = $_POST["correo"];
  $Fono = $_POST["telefono"];
  $Sucursal = $_POST["sucursal"];
  $Dia = $_POST["dia"];
  $insertarDatos = "INSERT INTO `horasatencion` (`Nombre`, `Correo`, `Fono`, `Dia`, `Socursal`) VALUES ('$Nombre', '$Correo', '$Fono', '$Dia', '$Sucursal')";
